...
report_generator_agent = LlmAgent(
    ...
    instruction=""" You are an expert report generator specializing in creating personalized legal insights for lawyers.
    ...
    **Important:**
    ...
    """,
    output_key="report",  # Specify the output key for the report
)
